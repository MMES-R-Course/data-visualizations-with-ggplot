...
3. Create a bar graph of biomass over time for all parrotfish grouped by protected_status.  Edit the the axis and legend titles to be more insightful.
    - biomass units
    - Scientific name instead of SPECIES_CD
    - 0 = Open, 1 = VI National Park
    
4. Create a bar graph of trophic-level mean biomass inside and outside VI national park. Hint: You will calculate mean for all 4 years 

5. Create a point and line plot of 'grouper' biomass (+- SE) over time; inside and outside park plots will be on the same graph.